...
let item = 0;
let mobileSize = window.matchMedia('(max-width: 650px)'); //This variable will be used to test the media query to load the correct img file;
...
//Mobile menu:
const mobileBtn = document.querySelectorAll('.mobile-menu-icon.only-mobile svg');
